...
namespace StartspelerMVC.Controllers
{
    public class DrankkaartTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DrankkaartTypeID,Grootte,Naam")] DrankkaartType drankkaartType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DrankkaartTypeID,Grootte,Naam")] DrankkaartType drankkaartType)
        {
